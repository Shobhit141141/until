...
- **Backend:** Node.js, Express, TypeScript. MongoDB (Mongoose) for users, runs, credit transactions, and question audit; Redis (optional) for challenge and deduplication state.
...
**Current production:** K = 100 (env: `SCALE_K`). Future tiers may expose K = 250 (Pro) and K = 500 (Elite) as part of subscription or skill-based tiers.
...
- **Version:** 1.0  
- **Status:** Living document; roadmap and future work are indicative and may change.  
